...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_background_field 'odd_teim', label: 'General note', helper_method: :render_html_tags
    config.add_background_field 'bibliography_teim', label: 'Bibliography', helper_method: :render_html_tags
    config.add_background_field 'fileplan_teim', label: 'File plan', helper_method: :render_html_tags
    config.add_background_field 'materialspec_teim', label: 'Materials specific details', helper_method: :render_html_tags
    ...
    config.add_component_field 'odd_teim', label: 'General note', helper_method: :render_html_tags
    config.add_component_field 'bioghist_teim', label: 'Biographical / Historical', helper_method: :render_html_tags
    config.add_component_field 'originalsloc_teim', label: 'Location of originals', helper_method: :render_html_tags
    config.add_component_field 'relatedmaterial_teim', label: 'Related material', helper_method: :render_html_tags
    config.add_component_field 'separatedmaterial_teim', label: 'Separated material', helper_method: :render_html_tags
    config.add_component_field 'otherfindaid_teim', label: 'Other finding aids', helper_method: :render_html_tags
    config.add_component_field 'bibliography_teim', label: 'Bibliography', helper_method: :render_html_tags
    config.add_component_field 'fileplan_teim', label: 'File plan', helper_method: :render_html_tags
    config.add_component_field 'materialspec_teim', label: 'Materials specific details', helper_method: :render_html_tags
